...
for t in times:
    arrival = t.text.split(" ")[0] + t.text.split(" ")[1]
    arrivals.append(arrival)
    depart = t.text.split(" ")[3]+ t.text.split(" ")[4]
...
#writer = csv.writer(csvfile, p=prices, d= duration, n=number, date='')
